...
<div style="width:100%; height:80px; overflow:hidden; margin: 0 auto; background-color:#333">
  ...
  <div style="width:950px; height:80px; margin: 0 auto; overflow:hidden; position:relative">
        ...
        <div id="caption"> Commodity Dashboard </div>
...
<div style="width:1000px; height:700px; overflow:visible; margin: 0 auto; position:relative; margin-top:35px;">
	...
	<div id="panel1" class="dashboardpanel"></div>
    <div id="panel2" class="dashboardpanel"></div>
    <div id="panel3" class="dashboardpanel"></div>

    <div id="panel4" class="dashboardpanel"></div>
    <div id="panel5" class="dashboardpanel"></div>
    <!--6.html--> 
    <a id="showPopup"><div id="panel6" class="dashboardpanel"></div></a>
    
    <div id="content" style="display:none; position:absolute;">
	    <iframe id="main" name="main" frameborder="0" height="100%" width="100%">
	    </iframe>
    </div>
</div>
...
$(document).ready(function(){
  ...
  TweenLite.to($("#panel1"),2,{css:{left:0},delay:0, ease:Power2.easeOut});
  TweenLite.to($("#panel2"),2,{css:{left:20},delay:0, ease:Power2.easeOut});
  TweenLite.to($("#panel3"),2,{css:{left:40},delay:0, ease:Power2.easeOut});
  TweenLite.to($("#panel4"),2,{css:{left:0},delay:0, ease:Power2.easeOut});
  TweenLite.to($("#panel5"),2,{css:{left:20},delay:0, ease:Power2.easeOut});
  TweenLite.to($("#panel6"),2,{css:{left:40},delay:0, ease:Power2.easeOut});
...
<script id="Panel6" type="text/javascript">
$(function () {
    $('#panel6').highcharts({
        chart: {},
        title: {
